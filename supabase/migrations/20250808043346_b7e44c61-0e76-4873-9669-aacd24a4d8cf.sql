-- Phase 1: Critical Analytics Security Fixes (Fixed)
...
DO $$ BEGIN
    ALTER TABLE public.analytics_rate_limit ADD CONSTRAINT analytics_rate_limit_unique UNIQUE (ip_address, session_id, window_start);
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;
