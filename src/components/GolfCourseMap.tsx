            ...
            >
              ...
              >
                ...
                <div className="flex flex-col gap-4 flex-grow min-w-0">
                  ...
                  {(zoomTarget.hole === 'clubhouse' || zoomTarget.hole === 2 || zoomTarget.hole === 3 || zoomTarget.hole === 4 || zoomTarget.hole === 5 || zoomTarget.hole === 6 || zoomTarget.hole === 7 || zoomTarget.hole === 8 || zoomTarget.hole === 9 || zoomTarget.hole === 10 || zoomTarget.hole === 11) && (
                    <div className="flex-grow overflow-hidden rounded-xl">
                      <img 
                        src={zoomTarget.hole === 'clubhouse' ? clubhousePhoto : zoomTarget.hole === 2 ? hole2Photo : zoomTarget.hole === 3 ? hole3Photo : zoomTarget.hole === 4 ? hole4Photo : zoomTarget.hole === 5 ? hole5Photo : zoomTarget.hole === 6 ? hole6Photo : zoomTarget.hole === 7 ? hole7Photo : zoomTarget.hole === 8 ? hole8Photo : zoomTarget.hole === 9 ? hole9Photo : zoomTarget.hole === 10 ? hole10Photo : hole11Photo} 
