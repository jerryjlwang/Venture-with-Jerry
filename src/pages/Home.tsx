...
const Home = () => {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex flex-col lg:flex-row gap-12">
        {/* Left: Logo Carousel */}
        ...
        <div className="lg:w-3/4 w-full">
          ...
          <section className="py-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center lg:text-left">
              Recent Posts
            </h2>
