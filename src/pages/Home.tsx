...
// Below-the-fold. Lazy so motion/embla don't bloat the critical bundle.
const FeaturedProjectsGallery = lazy(() => import('../components/FeaturedProjectsGallery'));
...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      <ScrollProgressBar />
      <ParticlesComponent
        className="-inset-x-[8%] -inset-y-[10%] [transform:scale(1.08)]"
        particleCount={220}
        linkDistance={190}
        linkOpacity={0.52}
        moveSpeed={1.8}
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="absolute inset-0">
                <Boxes className="opacity-85" rows={18} cols={14} />
                ...
                <div className="grid h-full grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-12">
                  ...
                  <div className="order-1 flex h-full items-center text-left lg:order-2 lg:col-span-7 lg:text-right">
                    <p className="m-0 max-w-2xl font-courier text-2xl leading-relaxed tracking-wide text-white sm:text-3xl md:text-4xl lg:ml-auto lg:text-5xl">
                      <TypewriterText
                        text="Get to know me and my personal projects."
                        speed={30}
            ...
            <div
              className={`mt-8 flex flex-col items-center gap-2 transition-all duration-700 ease-out lg:mt-12 lg:items-end ${subtitleComplete ? 'opacity-100 translate-y-0 animate-bounce' : 'opacity-0 translate-y-4'}`}
