      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-gray-800 rounded-lg p-8 space-y-6 text-gray-300">
          <div>
            ...
            <p className="mb-4">
              I collect anonymous analytics data to understand how visitors interact with my website. This includes:
            </p>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>Understand which content is most valuable to my visitors</li>
              <li>Optimize my website for different devices and browsers</li>
          ...
          <div>
            ...
            <p className="mb-4">
              Your data is stored securely using industry-standard practices. I:
            </p>
            <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <li>I respect "Do Not Track" browser settings</li>
            </ul>
          </div>
